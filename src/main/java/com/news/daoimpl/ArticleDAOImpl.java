...
public class ArticleDAOImpl implements ArticleDAO{
    ...
    @Override
    @Transactional
    public Company saveArticle(Long personId , Company newNews) {
        Company newsOne = new Company();
    ...
    @Override
    @Transactional
    public void deleteArticle(Long personId,Company news) {
    ...
    @Override
    public Company findArticle(Long id) {
    ...
    @Override
    public List<Company> findArticlesForDate(String date){
    ...
    @Override
    public List<Company> findArticlesForCreator(Long crtId){
    ...
    @Transactional
    @Override
    public Company changeArticlesCreator(Long pId, Long articleId, Long crtrId){
        if(isAdmin(pId)){
            User u = entityManager.find(User.class, crtrId);
            Company a = entityManager.find(Company.class, articleId);
            if(u!=null && a!=null){
                a.setCreator(u);
